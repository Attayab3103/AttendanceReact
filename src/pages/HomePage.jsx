      ...
      <div className="flex-grow flex flex-col items-center justify-center px-2 w-full">
        <div className="mb-8 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <h1 className="text-4xl font-extrabold text-gray-800 tracking-tight">Attendance App</h1>
          </div>
          <p className="text-lg text-gray-600">Effortless attendance tracking for teachers and parents</p>
        </div>
